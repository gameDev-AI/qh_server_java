...
import business.global.pk.gd.pkbase.optype.duiziex.DuiZiCardEx;
 ...
 * 两连队
 * */
public class LianDuiCardEx implements OpCardEx {
	...
	public PK_OpCard getLianDuiShunZi(ArrayList<Integer> cardList, PKRoomSetSound setSound) {
		ArrayList<PK_OpCard> duiZiList = PKLogicFactory.getOpCard(DuiZiCardEx.class).getOpCardList(cardList, setSound);
