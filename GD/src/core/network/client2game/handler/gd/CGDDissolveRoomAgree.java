 ...
 *
 */
public class CGDDissolveRoomAgree extends PlayerHandler {
    ...
    public void handle(Player player, WebSocketRequest request, String message) throws IOException {
    	...
    	if (null == room){
    		request.error(ErrorCode.ExitROOM_ERROR_NOTFINDROOM, "CGDDissolveRoomAgree not find room:"+req.getRoomID());
    		return;
    	}
